/*********
  Complete project details at http://projectiot123.com  
*********/
...
const int GPIO_PIN5 = 5;
const int GPIO_PIN4 = 4;
      ...
      {                         // if there's bytes to read from the client,
        ...
        { // if the byte is a newline character
          ...
          if (currentLine.length() == 0)
          {
            ...
            client.println("<svg width=\"300\" height=\"80\"><text fill=\"#FF0000\" font-family=\"serif\" font-size=\"24\" id=\"svg_1\" stroke=\"#000000\" text-anchor=\"middle\" transform=\"matrix(1.35388 0 0 1.42308 -6.66283 -8.67308)\" x=\"86.5\" xml:space=\"preserve\" y=\"41.5\">ProjectIOT123</text></svg>");
            client.println("<style>html { font-family: Cairo; display: inline; margin: 0px auto; text-align: center; background-color: #E2C0A3;}");
            ...
            // Web Page Heading
            client.println("<body><h1>Welcome to Nodemcu Web Server</h1>");
            /*GPIO 5 */
            ...
            client.println("<p>GPIO 3:State " + output5State + "</p>");
